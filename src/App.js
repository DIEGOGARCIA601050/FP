...
function App() {
  return (
    <div className='App'>
      ...
      <main>
       <ul>
        <li>Benito Juarez<span className='cita'> Entre los individuos como entre las naciones, el respeto al derecho ajeno es la paz</span></li>
        ...
        <li>Miguel Hidalgo<span className='cita'>“¡Viva la independencia! ¡Viva la América! ¡Muera el mal gobierno!”
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/ieSgPWjnMZ8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <li>Porfirio Diaz<span className='cita'> Orden y porgreso</span></li>
